...
def cleaned_text(text):
    ...
    # Replace text
    # temp_text_5=temp_text_4.replace('•', '')
    temp_text_5 = re.sub('[^a-zA-Z0-9 \n\.]', '', temp_text_4)
    #temp_text_6=temp_text_5.replace('#', ' ')
    #temp_text_7=temp_text_6.replace('$', ' ')
    #temp_text_8=temp_text_7.replace('*', ' ')
    #temp_text_9=temp_text_8.replace('@', ' ')
    #temp_text_10=temp_text_9.replace('^', ' ')
    #temp_text_11=temp_text_10.replace('%', ' ')
    #temp_text_12=temp_text_11.replace('&', ' ')
    return(temp_text_5)
